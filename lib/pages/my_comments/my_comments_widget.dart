...
import 'my_comments_model.dart';
export 'my_comments_model.dart';

class MyCommentsWidget extends StatefulWidget {
  const MyCommentsWidget({Key? key}) : super(key: key);
...
class _MyCommentsWidgetState extends State<MyCommentsWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MyCommentsModel());
  }
